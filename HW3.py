...
# Load the dataset
mpg_data = pd.read_csv(r'C:\Users\arifm\OneDrive\Documents\GitHub\data_skills_1_hw3\mpg.csv')
...
# Save the figure
plt.savefig('mpg_changes_subplot_grid.png')
...
unemp_data = pd.read_csv(r'C:\Users\arifm\OneDrive\Documents\GitHub\data_skills_1_hw3\unemp.csv')
epu_data = pd.read_excel(r'C:\Users\arifm\OneDrive\Documents\GitHub\data_skills_1_hw3\policy_uncertainty.xlsx')
